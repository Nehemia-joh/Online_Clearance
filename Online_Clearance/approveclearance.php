	...
	<header>
		<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
			<div class="container-fluid">
				<a class="navbar-brand" href="#">Examiner Account</a>
				...
				<div class="collapse navbar-collapse" id="navbarNav">
					<ul class="navbar-nav">
						...
						<li class="nav-item">
							<a class="nav-link" href="examiner.php">Dashboard</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="editadd.php"></a>
						</li>
						<li class="nav-item">
...
while($row=mysqli_fetch_array($result)){
    ...
    echo "<td><a href='approval_admin.php?id=".$row['clearance_id']."'>Approve</a></td>";
